    ...
    expect(
      () =>
        new OpenAiLlmVendor({
          ...
          CONTENT_PACK_SIGNING_MODE: 'dev',
          CONTENT_PACK_SIGNING_DEV_KEY_PATH: 'keys/dev-content-pack-private.jwk.json',
          CONTENT_PACK_SIGNING_DEV_PUBLIC_KEY_PATH: 'keys/dev-content-pack-public.jwk.json',
          CONTENT_PACK_ASSET_BASE_URL: 'http://localhost:4000/content-packs',
